...
API_ID = int(environ['API_ID', '18019745'])
API_HASH = environ['API_HASH', '59f97cf6abf6201b862551f66eae0762']
BOT_TOKEN = environ['BOT_TOKEN','6176065465:AAF3Bvumshvfjllw8m9PhpCDavFldl5zFzg']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '907416893 982105601').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '907416893').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'ntmgroup')
